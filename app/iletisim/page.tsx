        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Hukuki konularınızda size yardımcı olmaya hazırız. 
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      {siteConfig.firm.address.street}<br />
                      {siteConfig.firm.address.district}, {siteConfig.firm.address.city}<br />
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <p className="text-sm text-gray-600">
                      Acil durumlar için randevu saatleri dışında da görüşme sağlanabilir.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Hukuki konunuzu değerlendirmek için ücretsiz ön görüşme yapabilirsiniz. 
